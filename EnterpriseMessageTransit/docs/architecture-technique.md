...
L'itinéraire (`AppSettings.Itinerary`) définit une liste ordonnée d'audiences. Le consumer utilise `RouteToNextStageAsync` pour :
1. Déterminer l'étape suivante dans l'itinéraire.
