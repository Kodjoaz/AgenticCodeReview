...
{
    public class HotelConsumer : BaseConsumer<HotelMessage>
    {
        public HotelConsumer(
            IMessagingProvider messagingProvider,
            ILogger<HotelConsumer> logger,
        ...
        public override async Task<MessageTransitContext<MessageTransitResponse>> ConsumeAsync(
            MessageTransitContext<HotelMessage> context,
            CancellationToken cancellationToken)
        {
            ...
            {
                Logger.LogWarning("Annulation en cours HotelConsumer MessageId={MessageId}", context.MessageId);
                throw;
            }
            catch (Exception ex)
            {
                ...
                reply.Content = ex.Message;
                reply.IsTransient = true;
                Logger.LogError(ex, "Erreur HotelConsumer MessageId={MessageId}", context.MessageId);
